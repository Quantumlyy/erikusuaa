# Copyright 2016 Craig Dazey.
# File based on https://github.com/Kraigie/nostrum/blob/0658a6a7f5f7c7364ab7a9c23b73473da6ff548d/lib/nostrum/shard/intents.ex

defmodule Erikusuaa.Shard.Intents do
  @moduledoc false

  import Bitwise

  alias Erikusuaa.Config
  ...
  def get_enabled_intents do
    # If no intents are passed in
    case Config.gateway_intents() do
      :all ->
